...
describe('MongoAdapter', function () {
  ...
  describe('#findObjects()', function () {
    ...
    describe('simple objects', function () {
      ...
      it('should find objects by id', function () {
        return expect(mongoAdapter.findObjects(Person, {
          id: {
            $in: ['0ca3c8c9-41a7-4967-a285-21f8cb4db2c0', '5c2ca70f-d51a-4c97-a3ea-1668bde10fe7']
          }
        }))
          .to.become([john, theo])
    ...
    describe('objects with generalization', function () {
      ...
      it('should find objects by custom property', function () {
        return expect(mongoAdapter.findObjects(Author, {readers: {$gt: 500}}))
          .to.become([john, will])
          .and.collectionOf(Author);
      });
      ...
      it('should find objects by multiple properties', function () {
        return expect(mongoAdapter.findObjects(Author, {married: false, readers: 1000}))
          .to.become([will])
          .and.collectionOf(Author);
      });

      it('should find objects using parent\'s class', function () {
        return expect(mongoAdapter.findObjects(Person, {id: '0ca3c8c9-41a7-4967-a285-21f8cb4db2c0'}))
          .to.become([john])
          .and.collectionOf(Author);
      });

      it('should return empty array on query with no result', function () {
        return expect(mongoAdapter.findObjects(Author, {name: 'Nobody'}))
          .to.become([]);
      });
    });
    ...
    describe('objects with association', function () {
      ...
      it('should find objects by id', function () {
        return expect(mongoAdapter.findObjects(Author, {id: '0ca3c8c9-41a7-4967-a285-21f8cb4db2c0'}))
          .to.become([john])
          .and.collectionOf(Author);
      });
      ...
      it('should find objects by association id', function () {
        return expect(mongoAdapter.findObjects(Author, {'books.id': '2f3e8d4b-309c-4261-a462-6634ee8ca40d'}))
          .to.become([john])
          .and.collectionOf(Author);
      });
    });
